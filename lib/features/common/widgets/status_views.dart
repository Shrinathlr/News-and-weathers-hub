...
class ErrorRetryView extends StatelessWidget {
  ...
  const ErrorRetryView({super.key, required this.failure, required this.onRetry});
  ...
  IconData _iconFor(AppFailure f) {
    ...
    if (f is LocationServiceDisabledFailure) return Icons.location_disabled_rounded;
...
class OfflineBanner extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final timeStr = cachedAt != null ? DateFormat('MMM d, h:mm a').format(cachedAt!) : 'earlier';
    return Container(
